...
!yolo task=segment mode=train model=yolov8m-seg.pt data=/content/drive/MyDrive/Q500Project.v1i.yolov8/data.yaml epochs=50 imgsz=640

# Commented out IPython magic to ensure Python compatibility.
# %cd /content/drive/MyDrive
Image(filename=f'/content/drive/MyDrive/runs/segment/train3/confusion_matrix.png', width=600)

# Commented out IPython magic to ensure Python compatibility.
# %cd /content/drive/MyDrive
Image(filename=f'/content/drive/MyDrive/runs/segment/train3/results.png', width=600)

# Commented out IPython magic to ensure Python compatibility.
# %cd /content/drive/MyDrive
Image(filename=f'/content/drive/MyDrive/runs/segment/train3/val_batch0_pred.jpg', width=600)
...
!yolo task=segment mode=val model=/content/drive/MyDrive/runs/segment/train3/weights/best.pt data=/content/drive/MyDrive/Q500Project.v1i.yolov8/data.yaml

"""## Inference with Custom Model"""

# Commented out IPython magic to ensure Python compatibility.
# %cd /content/drive/MyDrive
!yolo task=segment mode=predict model=/content/drive/MyDrive/runs/segment/train3/weights/best.pt conf=0.7 source=/content/drive/MyDrive/Q500Project.v1i.yolov8/test/images save=true

import glob
from IPython.display import Image, display

for image_path in glob.glob(f'/content/drive/MyDrive/Q500Project.v1i.yolov8/runs/segment/predict/*.jpg')[:3]:
